<!-- ARCHIVED (2026-09-12, #9): the original SETUP.md of Repository-Template-v2, kept for
     reference. Every command and file below belongs to the product template, not to this corpus.
     The corpus adoption guide is /SETUP.md. -->
