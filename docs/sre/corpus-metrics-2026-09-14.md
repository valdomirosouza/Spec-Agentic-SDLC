...
| Metric | Value | Method |
| --- | --- | --- |
| Commits on the default branch | 102 | git log over the full history; a day is active when it carries >= 1 commit |
| Active days | 3 (span 3 days) | — |
| Commits per active day | 34.0 | — |
| First / last commit | 2026-09-12T23:14:09 → 2026-09-14T07:50:59 | — |
...
| --- | --- |
| Markdown files | 533 |
| Markdown lines | 60606 |
| Executable lines (scripts + hooks) | 4481 |
| Test lines | 2537 |
| Verification lines (scripts + hooks + tests) | 7018 |
| Prose to verification ratio | 8.6 : 1 |
...
| Executable lines (scripts + hooks) | 4481 | 45 |
| Test lines | 2537 | 25 |
| Verification lines (scripts + hooks + tests) | 7018 | 70 |
...
| Metric | Value | Method |
| --- | --- | --- |
| Commits on the default branch | 102 | wall-clock from the first to the last commit on the default branch; this is elapsed time, not effort, and includes every pause |
| Elapsed wall-clock | 32.6 h | first commit to last |
| Commits per elapsed hour | 3.1 | — |
| Cumulative diff | 466 files changed, 18226 insertions(+), 1526 deletions(-) | `git diff --shortstat` from the first commit |
