...
| Metric | Value | Method |
| --- | --- | --- |
| Commits on the default branch | 94 | git log over the full history; a day is active when it carries >= 1 commit |
| Active days | 2 (span 2 days) | — |
| Commits per active day | 47.0 | — |
| First / last commit | 2026-09-12T23:14:09 → 2026-09-13T21:56:49 | — |
...
| --- | --- |
| Markdown files | 533 |
| Markdown lines | 60548 |
| Executable lines (scripts + hooks) | 4245 |
| Test lines | 2247 |
| Verification lines (scripts + hooks + tests) | 6492 |
| Prose to verification ratio | 9.3 : 1 |
...
| Executable lines (scripts + hooks) | 4245 | 42 |
| Test lines | 2247 | 22 |
| Verification lines (scripts + hooks + tests) | 6492 | 65 |
...
| Metric | Value | Method |
| --- | --- | --- |
| Commits on the default branch | 94 | wall-clock from the first to the last commit on the default branch; this is elapsed time, not effort, and includes every pause |
| Elapsed wall-clock | 22.7 h | first commit to last |
| Commits per elapsed hour | 4.1 | — |
| Cumulative diff | 466 files changed, 17679 insertions(+), 1522 deletions(-) | `git diff --shortstat` from the first commit |
