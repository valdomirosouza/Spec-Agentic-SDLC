...
skip with an explanation_, not a failure. (Actually configuring the registry remains tracked in issue #96 —
this RFC removes the false-failure symptom, it does not publish images.)
