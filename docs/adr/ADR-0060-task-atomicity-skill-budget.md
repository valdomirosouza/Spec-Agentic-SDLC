...
Tracked as five atomic tasks (this ADR is task 1): #70 ADR (this), #71 CLAUDE.md §4, #72 AGENTS.md, #73
control-applicability matrix + trigger table, #74 session kickoff + phase-coverage wiring. The source directive (`task-atomicity-skill-budget-directive.md`,
