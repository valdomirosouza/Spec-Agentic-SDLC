...
| [ADR-0092](ADR-0092-command-lifecycle-hooks-vs-claude-code-hooks.md)      | spec-kit before/after hooks → UserPromptSubmit gate adopted, Stop-based continuation refused | Proposed   | 2026-09-13 |
