...
| - | --------------------------------------------------------------------- | ----------- | ------------------- |
| 1 | ~~First rule set for the datasets in the catalog~~ — done 2026-09-13 for this corpus's own datasets (14 rules, `scripts/python/check_data_quality.py`, #53); the adopter's datasets remain open | Data owners | 2026-11-27           |
| 2 | Reference source for any dataset claiming an accuracy target         | Data owners | on-event: Before claiming it |
| 3 | Lineage edges recorded for the datasets in the catalog               | Data stewards | 2026-11-27           |
...
- [`../../docs/data/data-catalog.md`](../../docs/data/data-catalog.md) — where rules and SLOs are registered per dataset
